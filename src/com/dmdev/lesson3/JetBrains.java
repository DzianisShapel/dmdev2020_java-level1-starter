 ...
 * The enrollment has ended, and now the task is to count the number of desks to order the correct number from the shop.
 * Of course, the university is short of money, so you need to calculate the minimum number of desks.
...
public class JetBrains {
    public static void main(String[] args) {
        ...
        int desks = (firstGroup / 2) + (firstGroup % 2) + (secondGroup / 2) + (secondGroup % 2) + (thirdGroup / 2) + (thirdGroup % 2);
